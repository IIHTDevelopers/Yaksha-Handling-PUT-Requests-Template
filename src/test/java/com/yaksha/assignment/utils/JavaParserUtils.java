...
public class JavaParserUtils {
	...
	public static boolean checkControllerStructure(String filePath, String classAnnotations, String methodName,
		...
		try {
			method = compilationUnit.getClassByName("AppController").get().getMethodsByName(methodName).get(0);
		...
		// Check if the method's parameter has the required annotation (RequestBody)
